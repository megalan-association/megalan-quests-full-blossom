  ...
  return (
    <div className="grid grid-cols-[1fr_auto_1fr]">
      <div className="text-right">
        <Image src="/h1-petals.png" alt="Header banner" className="inline h-10 sm:h-12" />
      </div>
      ...
      <div className="text-left">
        <Image src="/h1-petals.png" alt="Header banner" className="inline h-10 sm:h-12 -scale-x-100" />
      </div>
    </div>
  )
}
